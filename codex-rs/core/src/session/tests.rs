...
#[tokio::test]
#[ignore = "codex-lhc LIM-142 strict-lhc-routing: owned assertion is the native remote pre-sampling compact request (and its fallback) after a comp-hash change; the LHC arm owns pre-sampling compaction and never issues it"]
