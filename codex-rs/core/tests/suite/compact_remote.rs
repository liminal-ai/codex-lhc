...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore = "codex-lhc LIM-142 strict-lhc-routing: owned assertion is remote v2 compact recording usage before output validation"]
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore = "codex-lhc LIM-142 strict-lhc-routing: owned assertion is remote v2 compact rewrite of trailing function-call outputs"]
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore = "codex-lhc LIM-142 strict-lhc-routing: owned assertion is native compaction refreshing realtime start instructions"]
