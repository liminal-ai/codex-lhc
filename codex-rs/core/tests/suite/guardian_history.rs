...
#[ignore = "codex-lhc LIM-142 strict-lhc-routing: TokenBudget start_new_context_window root eviction; LHC fallback residue keeps pre-compact user text; TokenBudget+LhcCaptureSlot rejected at session start"]
...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore = "codex-lhc LIM-142 strict-lhc-routing: TokenBudget window reset drops pre-compact tool calls from root; LHC residue does not"]
