...
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
#[ignore = "codex-lhc F7: budgeted mount_sse_sequence counts requests; LHC background derivation POSTs consume the budget and the resumed turn 404s - harness artifact, prod unaffected; re-enable when fixtures budget derivation traffic or mock unbudgeted"]
