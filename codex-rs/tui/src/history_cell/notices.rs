...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = match &self.update_action {
            ...
            None => line![
                "See ",
                LHC_INSTALL_DOCS_URL.fg(accent_color()).underlined(),
        ...
        let content = text![
            line![
                ...
                "Codex + LHC update available!".bold().fg(accent_color()),
                " ",
            ...
            LHC_RELEASES_URL.fg(accent_color()).underlined(),
        ];
