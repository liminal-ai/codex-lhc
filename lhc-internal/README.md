# LHC internal archive

Working plans, review rounds, certification fixtures, and retained live-run
...
The reader-facing surface is intentionally limited to the root banner plus
`lhc-docs/README.md` and `lhc-docs/INSTALL.md`. Current maintenance law lives
in `FORK.md`; historical files here do not override it.
